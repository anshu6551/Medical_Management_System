...
router.post('/create-stripe-intent', AuthCheck, (req, res) => {
  // #swagger.tags = ['Patient Portal']
  patientController.createStripePaymentIntent(req, res);
});

// 8. Confirm Stripe Payment & Book Appointment
router.post('/confirm-stripe-booking', AuthCheck, (req, res) => {
  // #swagger.tags = ['Patient Portal']
  patientController.confirmStripePaymentAndBook(req, res);
});
